...
.. note:: 
    Use of SlicerDESI requires 3D Slicer. If you are new to 3D Slicer, we recommend that you start be referenceing some of the 3D Slicer resources : `3D Slicer <https://www.slicer.org/wiki/Documentation/4.10/Training>`_\ 
